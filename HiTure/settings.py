"""
Django settings for HiTure project.
...
SECRET_KEY = '%#kvi6nnriu@bjo0wc@^w5b4zm3q!(c7=zc^0y7c7v)bphhhhs'
...
WSGI_APPLICATION = 'HiTure.wsgi.application'
...
MEDIA_URL =  '/media/'
MEDIA_ROOT = 'C:/proyectos_django/HiTure/AppHiTure/static'
